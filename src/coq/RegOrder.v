...
Proof.
   induction l.
    - right. intro. simpl in *. assumption.
...
Proof.
    split.
    - induction l.
        + intro. simpl in *. split.
            * assumption.
            * exfalso. assumption.
        + simpl in *. case RE.eqb_spec.
            * intros. split.
                ** left. 
Admitted.
...
Proof.
    ...
    - simpl. reflexivity.
    - simpl in *. case RE.eqb_spec.
        + intro. exfalso. apply H. left. symmetry. assumption.
        + simpl. intros. assert (remove a l = l). {
            apply IHl. intro. apply H. right. assumption.
...
Proof.
    ...
    - simpl in *. intro. split.
        + intro. case RE.eqb_spec.
            ** intro. simpl in *. destruct H0.
                *** left. rewrite H0 in e. assumption.
...
Proof.
    ...
    - intro. induction l.
        + split.
            * intro. simpl in *. contradiction.
            * intro. simpl in *. induction l'.
...
Proof.
    induction l.
    - simpl. intro. intro. intro. exfalso. assumption.
    - intro. simpl in *. case RE.eqb_spec.
        + simpl in *. unfold Subset in *. intros. apply IHl.
            * intros. simpl in *. apply H. right. assumption.
            * assumption.
        + simpl in *. unfold Subset in *. intros. apply IHl.
...
Proof.
    intro. unfold Subset in *. exists v. split.
    - intro. split.
